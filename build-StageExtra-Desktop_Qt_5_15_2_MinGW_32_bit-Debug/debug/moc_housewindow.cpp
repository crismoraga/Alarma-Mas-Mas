...
#include <memory>
#include "../../Stage Extra/housewindow.h"
...
QT_MOC_LITERAL(4, 59, 10) // "alarmCheck"

    },
    "HouseWindow\0on_pushButton_clicked\0\0"
    "on_pushButton_2_clicked\0alarmCheck"
};
...
void HouseWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<HouseWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
